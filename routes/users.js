...
router.post('/contractNotice', (req, res) => {
  ...
  var contractDetail = `https://ut-1612018-1612175-client.netlify.com/contract-details/id=${id_contract}`;
  var agreeUrl = `https://ut-1612018-1612175-client.netlify.com/replyContract/id=${id_contract}&reply=${1}`;
  var disagreeUrl = `https://ut-1612018-1612175-client.netlify.com/replyContract/id=${id_contract}&reply=${0}`;
